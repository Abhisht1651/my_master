...
import FollowedEntitiesScreen from '../../../App/Containers/Dashboard/FollowedEntitiesScreen'
...
describe('FollowedEntitiesScreen', () => {
  let wrapper
  let props
  beforeEach(() => {
    props = createTestProps({})
    // eslint-disable-next-line react/jsx-props-no-spreading
    wrapper = shallow(<FollowedEntitiesScreen {...props} />) // no compile-time error
  })
