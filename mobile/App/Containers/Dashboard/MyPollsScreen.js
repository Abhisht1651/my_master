...
import styles from '../Styles/Dashboard/MyPollsScreenStyle'
...
const MyPollsScreen = (props: Props) => {
  ...
  return (
    <View style={styles.container}>
      <View style={Platform.OS === 'ios' ? styles.topbarios : styles.topbar}>
        ...
        <Text style={styles.topbarText}>My polls</Text>
      </View>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <FlatList data={Data} renderItem={renderpolls} style={styles.newsComponentContainer} />
      </ScrollView>
    </View>
  )
}

MyPollsScreen.defaultProps = {
  onSearchHandler: () => {}
}
