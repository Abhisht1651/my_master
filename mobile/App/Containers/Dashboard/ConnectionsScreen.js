...
import styles from '../Styles/Dashboard/ConnectionsScreenStyle'
  ...
  return (
    <View style={styles.headerPosition}>
      ...
      <Header
        ...
        onPressBack={() => props.navigation.navigate('InviteFriendsScreen')}
        rightText="Invite Friends"
      />
      <ScrollView style={styles.scrollBackground} showsVerticalScrollIndicator={false}>
      ...
      <LinearGradient colors={['#FFFFFF00', '#F7F7F7']} style={styles.gradient}>
        <LargeButton title="Done" onPress={() => props.navigation.navigate('NewsFeed')} />
        {/* <RoundedButton
