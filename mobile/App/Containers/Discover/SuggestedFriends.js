...
// Styles
import styles from '../Styles/Discover/SuggestedFriendsStyle'
...
const suggestedFriends = (props: Props) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.relatedText}>Suggested Friends</Text>
      </View>
