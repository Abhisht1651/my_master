...
type Props = {
  toggleHandlerDeactivate?: PropTypes.func
}

export default function Deactivate(props: Props) {
  const { toggleHandlerDeactivate } = props
  return (
        ...
        <View style={styles.box}>
          ...
          <View style={{ paddingLeft: (32 / 375) * Width, paddingRight: (31 / 375) * Width }}>
            <Text style={styles.contText}>
              Are you sure you want to deactivate this account? You can never recover your account
              in the future.
            </Text>
          </View>
