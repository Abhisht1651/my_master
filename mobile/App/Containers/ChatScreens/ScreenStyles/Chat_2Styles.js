...
export default StyleSheet.create({
  ...
  photo1: {
    position: 'absolute',
    height: (32 / 768) * Height,
    width: (32 / 768) * Height,
    borderRadius: (16 / 768) * Height
  },
  photo2: {
    height: (32 / 768) * Height,
    width: (32 / 768) * Height,
  ...
  attach: {
    left: (25.75 / 375) * Width,
    height: (26 / 768) * Height,
    width: (24 / 768) * Width
  },
  attachsize: {
    width: (23 / 768) * Height,
    height: (25 / 768) * Height
  },
  sticker: {
    position: 'absolute',
    right: (60 / 375) * Width
