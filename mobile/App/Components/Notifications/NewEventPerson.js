...
import styles from './Styles/NewEventPersonStyle'
...
export default function NewEventPerson(props: Props) {
  const [hidden, setHidden] = useState(true)
  const { seen, name, img, people, time, index } = props
        ...
        <View style={common.flexRow}>
          <View style={{ width: (66 / 375) * Width }}>
            <View style={styles.iconTrendingPos}>
              <Image source={img} style={styles.iconTrending} />
            </View>
          </View>
            ...
            <View style={common.flexRowBet}>
              <View
                ...
                <Text style={styles.text1}>
                  <Text style={styles.boldFont}>{name}</Text> has a new event.
                </Text>
              </View>
