...
import styles from './Styles/BreakingNewsStyle'
      ...
      <View style={seen ? {} : common.bColor}>
        ...
        <View style={common.flexRow}>
          <View style={{ width: (66 / 375) * Width }}>
            <View style={styles.iconTrendingPos}>
              <Image source={Images.iconTrending} style={styles.iconTrending} />
            </View>
          </View>
          <View style={{ width: (287 / 375) * Width }}>
            <View style={common.flexRowBet}>
              <View style={{ paddingTop: (23 / 812) * Height, width: (232 / 375) * Width }}>
                <Text style={styles.text1}>
                  <Text style={styles.boldFont}>Breaking news:</Text>
                  {story}
                </Text>
              </View>
...
BreakingNews.defaultProps = {
  seen: false,
  story: 'This is the name of the story line ,this can be two lines long',
  people: '12K',
  time: '5 min',
  index: 10
}
