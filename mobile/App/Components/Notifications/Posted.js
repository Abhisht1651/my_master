...
export default function Posted(props: Props) {
  const [hidden, setHidden] = useState(true)
  const { seen, name, time, post, img, index } = props
            ...
            <View style={common.flexRowBet}>
              <View style={{ width: (232 / 375) * Width }}>
                <Text style={styles.text1}>
                  <Text style={styles.semiboldFont}>{name}</Text> posted{' '}
                  <Text style={common.color1}>{post}</Text> in his wall.
                </Text>
              </View>
