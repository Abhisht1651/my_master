...
export default function AcceptFriendRequest(props: Props) {
            ...
            <View style={common.flexRowBet}>
              <View style={{ width: (232 / 375) * Width }}>
                <Text style={styles.text1}>
                  <Text style={styles.semiboldFont}>{name} </Text> accepted your friend request
                </Text>
              </View>
...
AcceptFriendRequest.defaultProps = {
  seen: false,
  name: 'Narendra Modi',
  img: Images.trump,
  time: '1 min',
