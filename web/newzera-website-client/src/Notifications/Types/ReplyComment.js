...
function ReplyComment(props: Props) {
    ...
    <div className={seen ? '' : 'seenBackNOT'}>
      ...
      <div className="flex1NOT">
        <div className="iconNOT" style={{ paddingTop: '0.5vh' }}>
          ...
          <img src={Images.John} className="personImgNOT" alt="" />
          <img src={Images.Msg} className="msgImgNOT" alt="" />
        </div>
        <div style={{ width: '20vw' }}>
          <div className="flex2NOT">
            <div style={{ width: '12.4vw', paddingTop: '0.24vh' }}>
              <span className="text1NOT">Breaking News:</span>
          ...
          <div className="flex2NOT">
            <div style={{ width: '15.4vw' }}>
              <span className="text3NOT">
                {num < 1000 ? num : `${Math.floor(num / 1000)}k`} people talking about this
              </span>
            </div>
            <div style={{ paddingRight: '1.2vw' }}>
...
ReplyComment.defaultProps = {
  seen: false,
  topic: 'The USA has established a new law that forces…',
  num: 34422,
  time: '1 min'
}
